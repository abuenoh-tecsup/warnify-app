...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Documento de Identidad y Ocupación -->
        <div class="mt-4 flex space-x-4">
            <!-- Documento de Identidad -->
            <div class="w-1/2">
                <x-input-label for="documento_identidad" :value="__('Documento de Identidad')" />
                <x-text-input id="documento_identidad" class="block mt-1 w-full" type="text" name="documento_identidad" :value="old('documento_identidad')" required autocomplete="documento_identidad" maxlength="8" />
        ...
        <div class="mt-4 flex items-center space-x-4">
            <!-- Label -->
            <x-input-label for="notifi_acti" :value="__('Estado de Notificaciones')" class="whitespace-nowrap" />
            <!-- Radio Buttons -->
